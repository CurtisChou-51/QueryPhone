...
{
    public class MeanlyClient : IQueryPhoneClient
    {
        private readonly ILogger _logger;
        private readonly IHttpClientFactory _httpClientFactory;

        private string QueryUrl(string phone) => $"https://mean.ly/tw/{phone}";

        public MeanlyClient(ILogger<BaselyClient> logger, IHttpClientFactory httpClientFactory)
        {
            _logger = logger;
            _httpClientFactory = httpClientFactory;
        }

        public string Name => "Meanly 搜索您想知道的電話號碼";
        ...
        {
            var nodes = doc.DocumentNode.SelectNodes("//div[@class='comments']//div[@class='comment']");
            if (nodes == null)
                yield break;
        ...
        {
            var nodes = doc.DocumentNode.SelectNodes("//div[@class='phone-info']//div");
            if (nodes == null)
                yield break;
